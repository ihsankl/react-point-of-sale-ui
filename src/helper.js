...
export const checkHeldKeysRecursive = (
  ...
  // While holding down one of the keys,
  // if another is to be let go, the shortcut
  // should be void. Shortcut keys must be held down in a specifc order.
  // This function is always called
  // before a key is added to held keys on keydown,
  ...
  // with the previous key as the new shortcut key
